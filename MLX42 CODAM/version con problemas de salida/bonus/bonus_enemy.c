...
/*   Updated: 2025/04/25 19:29:41 by gavivas-         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	game->enemy.sprites[0] = ft_load_png(game->mlx, "textures/enemy_f1.png", game);
	game->enemy.sprites[2] = ft_load_png(game->mlx, "textures/enemy_l1.png", game);
	game->enemy.sprites[1] = ft_load_png(game->mlx, "textures/enemy_b1.png", game);
	game->enemy.sprites[3] = ft_load_png(game->mlx, "textures/enemy_r1.png", game);
}
