...
/*   Updated: 2025/04/11 21:15:42 by gavivas-         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	ft_draw_floor(t_game *game, t_textures *tx) //imprime en la ventana el tileset.
{
	...
	while (game->map[y]) //si hay filas en el mapa entra.
	{
		...
		{
			mlx_put_image_to_window(game->mlx, game->win, tx->grass, (x * TILE), (y * TILE));
			x++; //cambia de columna.
		}
		y++; //cambia de fila.
	}
...
void	ft_draw_walls(t_game *game, t_textures *tx)
{
	...
	while (game->map[y]) //si hay filas en el mapa entra.
	{
		...
		while (game->map[y][x]) //si hay columnas en la fila entra.
		{
			...
			{
				mlx_put_image_to_window(game->mlx, game->win, tx->wall, (x * TILE), (y * TILE));
			}
			x++; //cambia de columna.	
		}
		y++; //cambia de fila.
...
void	ft_draw_exit(t_game *game, t_textures *tx)
{
	...
	while (game->map[y]) //si hay filas en el mapa entra.
	{
		...
		while (game->map[y][x]) //si hay columnas en la fila entra.
		{
			...
			{
				mlx_put_image_to_window(game->mlx, game->win, tx->exit, (x * TILE), (y * TILE));
			}
			x++; //cambia de columna.	
		}
		y++; //cambia de fila.
...
void	ft_draw_collect(t_game *game, t_textures *tx)
{
	...
	while (game->map[y]) //si hay filas en el mapa entra.
	{
		...
		while (game->map[y][x]) //si hay columnas en la fila entra.
		{
			...
			{
				mlx_put_image_to_window(game->mlx, game->win, tx->collect, (x * TILE), (y * TILE));
			}
			x++; //cambia de columna.	
		}
		y++; //cambia de fila.
...
void	ft_draw_player(t_game *game, t_textures *tx)
{
	...
	while (game->map[y]) //si hay filas en el mapa entra.
	{
		...
		while (game->map[y][x]) //si hay columnas en la fila entra.
		{
			...
			{
				mlx_put_image_to_window(game->mlx, game->win, tx->player, (x * TILE), (y * TILE));
				return;
			}
			x++; //cambia de columna.	
		}
